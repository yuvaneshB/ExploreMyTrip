...
import { 
  Briefcase, MapPin, List, AlertCircle, BarChart3, User, LogOut, MessageSquare, FileText
} from 'lucide-react';
...
export const ManagerSidebar = () => {
  ...
  const links = [
    { name: 'Dashboard', path: '/manager/dashboard', icon: BarChart3, end: true },
    { name: 'Tour Management', path: '/manager/dashboard/tours', icon: List },
    { name: 'Booking Management', path: '/manager/dashboard/bookings', icon: Briefcase },
    { name: 'Customer Requests', path: '/manager/dashboard/requests', icon: AlertCircle },
    { name: 'Reviews & Ratings', path: '/manager/dashboard/reviews', icon: MessageSquare },
    { name: 'Reports', path: '/manager/dashboard/reports', icon: FileText },
    { name: 'Profile', path: '/manager/dashboard/profile', icon: User },
  ...
  return (
    <div className="w-full md:w-64 shrink-0 bg-white border-r border-slate-200 p-6 flex flex-col gap-6 font-sans md:h-full md:overflow-y-auto">
      <div>
        ...
        <p className="text-sm font-semibold text-gold-600">Operations Control</p>
      </div>
